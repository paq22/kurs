...
class OrdersControllerTest < ActionController::TestCase
  ...
  test "should create order" do
    assert_difference('Order.count') do
      post :create, order: { client_id: @order.client_id, cost_goods: @order.cost_goods, delivery_method: @order.delivery_method, list_products: @order.list_products, order_date: @order.order_date, order_number: @order.order_number, payment_method: @order.payment_method, total_cost: @order.total_cost }
    end
